...
module.exports.run = async function ({ api, event, args, Users }) {
 ...
 let r = "Bolo baby";
 if (uid === ADMIN_ID) {
   r = `জি বস আয়ান, বলুন আপনাকে কীভাবে সাহায্য করতে পারি? ❤️`;
 }
 ...
 if (uid === ADMIN_ID) {
   replies = replies.map(r => `জি বস আয়ান, ${r} 🫡❤️`);
 }
...
module.exports.handleEvent = async function ({ api, event, Users }) {
 ...
 const adminGreetings = [
   "আসসালামু আলাইকুম বস আয়ান! বলুন আপনাকে কীভাবে সাহায্য করতে পারি? ❤️",
   "জি বস আয়ান, বলুন শুনছি। আপনার যেকোনো আদেশ শিরোধার্য! 🫡",
   "আরে বস আয়ান! আপনাকে দেখে খুব ভালো লাগলো। বলুন কী করতে হবে? ✨",
   "জি বস আয়ান! আমি সবসময় আপনার সেবায় প্রস্তুত আছি। 🥰",
   "বলুন বস আয়ান, আপনার কি লাগবে?"
 ];
 ...
 const greetings = [
        ...
        "আমাকে না ডেকে মেয়ে হলে বস আয়ান এর ইনবক্সে চলে যা 🌚😂 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        ...
        "আমাকে ডেকো না,আমি বস আয়ান এর সাথে ব্যাস্ত আছি",
        "কি হলো , মিস্টেক করচ্ছিস নাকি🤣",
        "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
        "জান মেয়ে হলে বস আয়ান এর ইনবক্সে চলে যাও 😍🫣💕 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        ...
        "ভালোবাসার নামক আবলামি করতে চাইলে বস আয়ান এর ইনবক্সে গুতা দিন ~🙊😘🤣 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        ...
        "জান তোমার বান্ধবী রে আমার বস আয়ান এর হাতে তুলে দিবা-🙊🙆‍♂",
        ...
        "জান হাঙ্গা করবা-🙊😝🌻",
        "জান মেয়ে হলে চিপায় আসো বস আয়ান এর থেকে অনেক ভালোবাসা শিখছি তোমার জন্য-🙊🙈😽",
        "ইসস এতো ডাকো কেনো লজ্জা লাগে তো-🙈🖤🌼",
        "আমার বস আয়ান এর পক্ষ থেকে তোমারে এতো এতো ভালোবাসা-🥰😽🫶 আমার বস আয়ান ইসলামে'র জন্য দোয়া করবেন-💝💚🌺🌻",
        "- ভালোবাসা নামক আব্লামি করতে মন চাইলে আমার বস আয়ান এর ইনবক্স চলে যাও-🙊🥱👅 🌻𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 𝐋𝐈𝐍𝐊 🌻:- https://www.facebook.com/profile.php?id=61591763713247",
        "আমার জান তুমি শুধু আমার আমি তোমারে ৩৬৫ দিন ভালোবাসি-💝🌺😽",
        "কিরে প্রেম করবি তাহলে বস আয়ান এর ইনবক্সে গুতা দে 😘🤌 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        "জান আমার বস আয়ান কে বিয়ে করবা-🙊😘🥳",
        ...
        "প্রেম করতে চাইলে বস আয়ান এর ইনবক্সে চলে যা 😏🐸 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        ...
        "ভালোবাসার নামক আবলামি করতে চাইলে বস আয়ান এর ইনবক্সে গুতা দিন🤣😼",
        "মেয়ে হলে বস আয়ান এর ইনবক্সে চলে যা 🤭🤣😼 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
