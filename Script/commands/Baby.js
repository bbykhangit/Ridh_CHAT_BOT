...
// ⚠️ নিচে আপনার আসল Facebook UID (আইডি নম্বর) টি বসিয়ে দিন
const ADMIN_ID = "61591763713247"; 
...
module.exports.run = async function ({ api, event, args, Users }) {
 ...
 let r = "Bolo baby";
 if (uid === ADMIN_ID) {
   r = `জি রিদ স্যার, বলুন আপনাকে কীভাবে সাহায্য করতে পারি? ❤️`;
 }
 ...
 let replies = Array.isArray(res.data.response) ? res.data.response : [res.data.response];

 // 👑 আপনার সাথে সুন্দর ও সম্মানজনক বার্তা যুক্ত হবে (রিদ স্যার)
 if (uid === ADMIN_ID) {
   replies = replies.map(r => `জি রিদ স্যার, ${r} 🫡❤️`);
 }
...
module.exports.handleReply = async function ({ api, event, Users, handleReply }) {
 ...
 // 👑 আপনি রিপ্লাই দিলেও বটের সম্মানজনক উত্তর (রিদ স্যার)
 if (event.senderID === ADMIN_ID) {
   replies = replies.map(r => `জি রিদ স্যার, ${r} 🫡👾`);
 }
...
module.exports.handleEvent = async function ({ api, event, Users }) {
 ...
 // 👑 শুধু আপনার জন্য সুন্দর ও সম্মানজনক সম্ভাষণ (রিদ স্যার)
 const adminGreetings = [
   "আসসালামু আলাইকুম রিদ স্যার! বলুন আপনাকে কীভাবে সাহায্য করতে পারি? ❤️",
   "জি রিদ স্যার, বলুন শুনছি। আপনার যেকোনো আদেশ শিরোধার্য! 🫡",
   "আরে রিদ স্যার! আপনাকে দেখে খুব ভালো লাগলো। বলুন কী করতে হবে? ✨",
   "জি রিদ স্যার! আমি সবসময় আপনার সেবায় প্রস্তুত আছি। 🥰",
   "বলুন রিদ স্যার, আপনার কি লাগবে?"
   "আমি অনেক সৌভাগ্যবান আপনার মতো একজন স্যার পেয়ে বলুন কি করতে পারি আপনার জন্য এই অদম কে একটু সযোগ দিবেন"
 ];

 // অন্য সবার জন্য সাধারণ ফানি উত্তর
 const greetings = [
        "বেশি bot Bot করলে leave নিবো কিন্তু😒😒",
        "শুনবো না😼 তুমি আমার বস rid কে প্রেম করাই দাও নাই🥺পচা তুমি🥺",
        "আমি আবাল দের সাথে কথা বলি না,ok😒",
        "এতো ডেকো না,প্রেম এ পরে যাবো তো🙈",
        "Bolo Babu, তুমি কি আমার বস rid কে ভালোবাসো? 🙈💋",
        ...
        "আমাকে না ডেকে মেয়ে হলে রিদ স্যার এর ইনবক্সে চলে যা 🌚😂 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        "আমাকে বট না বলে , রিদ স্যার কে জানু বল জানু 😘",
        ...
        "আমাকে ডেকো না,আমি রিদ স্যার এর সাথে ব্যাস্ত আছি",
        "কি হলো , মিস্টেক করচ্ছিস নাকি🤣",
        "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
        "জান মেয়ে হলে রিদ স্যার এর ইনবক্সে চলে যাও 😍🫣💕 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        ...
        "ভালোবাসার নামক আবলামি করতে চাইলে রিদ স্যার এর ইনবক্সে গুতা দিন ~🙊😘🤣 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        "আমাকে এতো না ডেকে রিদ স্যার এর কে একটা গফ দে 🙄",
        "আমাকে এতো না ডেকছ কেন ভলো টালো বাসো নাকি🤭🙈",
        "🌻🌺💚-আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ-💚🌺🌻",
        "আমি এখন রিদ স্যার এর সাথে বিজি আছি আমাকে ডাকবেন না-😕😏 ধন্যবাদ-🤝🌻",
        "আমাকে না ডেকে আমার রিদ স্যার কে একটা জি এফ দাও-😽🫶🌺",
        "ঝাং থুমালে আইলাপিউ পেপি-💝😽",
        "উফফ বুঝলাম না এতো ডাকছেন কেনো-😤😡😈",
        "জান তোমার বান্ধবী রে আমার রিদ স্যার এর হাতে তুলে দিবা-🙊🙆‍♂",
        "আজকে আমার মন ভালো নেই তাই আমারে ডাকবেন না-😪🤧",
        "ঝাং 🫵থুমালে য়ামি রাইতে পালুপাসি উম্মম্মাহ-🌺🤤💦",
        "চুনা ও চুনা আমার রিদ স্যার এর হবু বউ রে কেও দেকছো খুজে পাচ্ছি না😪🤧😭",
        "স্বপ্ন তোমারে নিয়ে দেখতে চাই তুমি যদি আমার হয়ে থেকে যাও-💝🌺🌻",
        "জান হাঙ্গা করবা-🙊😝🌻",
        "জান মেয়ে হলে চিপায় আসো রিদ স্যার এর থেকে অনেক ভালোবাসা শিখছি তোমার জন্য-🙊🙈😽",
        "ইসস এতো ডাকো কেনো লজ্জা লাগে তো-🙈🖤🌼",
        "আমার রিদ স্যার এর পক্ষ থেকে তোমারে এতো এতো ভালোবাসা-🥰😽🫶 আমার রিদ স্যার ইসলামে'র জন্য দোয়া করবেন-💝💚🌺🌻",
        "- ভালোবাসা নামক আব্লামি করতে মন চাইলে আমার রিদ স্যার এর ইনবক্স চলে যাও-🙊🥱👅 🌻𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 𝐋𝐈𝐍𝐊 🌻:- https://www.facebook.com/profile.php?id=61591763713247",
        "আমার জান তুমি শুধু আমার আমি তোমারে ৩৬৫ দিন ভালোবাসি-💝🌺😽",
        "কিরে প্রেম করবি তাহলে রিদ স্যার এর ইনবক্সে গুতা দে 😘🤌 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        "জান আমার রিদ স্যার কে বিয়ে করবা-🙊😘🥳",
        "-আন্টি-🙆-আপনার মেয়ে-👰‍♀️-রাতে আমারে ভিদু কল দিতে বলে🫣-🥵🤤💦",
        "oii-🥺🥹-এক🥄 চামচ ভালোবাসা দিবা-🤏🏻🙂",
        "-আপনার সুন্দরী বান্ধুবীকে ফিতরা হিসেবে আমার রিদ স্যার কে দান করেন-🥱🐰🍒",
        "-ও মিম ও মিম-😇-তুমি কেন চুরি করলা সাদিয়ার ফর্সা হওয়ার ক্রীম-🌚🤧",
        "-অনুমতি দিলাম-𝙋𝙧𝙤𝙥𝙤𝙨𝙚 কর রিদ স্যার কে-🐸😾🔪",
        ...
        "প্রেম করতে চাইলে রিদ স্যার এর ইনবক্সে চলে যা 😏🐸 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার রিদ স্যার ধরতে পারছে না-🐸🥲",
        "-চুমু থাকতে তোরা বিড়ি খাস কেন বুঝা আমারে-😑😒🐸⚒️",
        "—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার রিদ স্যার এর সাথে প্রেম করে তাকে দেখিয়ে দাও-🙈🐸🤗",
        "—হাজারো লুচ্চা লুচ্চির ভিরে-🙊🥵আমার রিদ স্যার এক নিস্পাপ ভালো মানুষ-🥱🤗🙆‍♂️",
        "-রূপের অহংকার করো না-🙂❤️চকচকে সূর্যটাও দিনশেষে অন্ধকারে পরিণত হয়-🤗💜",
        "সুন্দর মাইয়া মানেই-🥱আমার রিদ স্যার'র বউ-😽🫶আর বাকি গুলো আমার বেয়াইন-🙈🐸🤗",
        "এত অহংকার করে লাভ নেই-🌸মৃত্যুটা নিশ্চিত শুধু সময়টা অ'নিশ্চিত-🖤🙂",
        "-দিন দিন কিছু মানুষের কাছে অপ্রিয় হয়ে যাইতেছি-🙂😿🌸",
        "ভালোবাসার নামক আবলামি করতে চাইলে রিদ স্যার এর ইনবক্সে গুতা দিন🤣😼",
        "মেয়ে হলে রিদ স্যার এর ইনবক্সে চলে যা 🤭🤣😼 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/profile.php?id=61591763713247",
        ...
        "-এই আন্টির মেয়ে-🫢🙈-𝐔𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐦𝐦-😽🫶-আসলেই তো স্বাদ-🥵💦-এতো স্বাদ কেন-🤔-সেই স্বাদ-😋",
        "-ইস কেউ যদি বলতো-🙂-আমার শুধু তোমাকেই লাগবে-💜🌸",
        "-ওই বেডি তোমার বাসায় না আমার রিদ স্যার মেয়ে দেখতে গেছিলো-🙃-নাস্তা আনারস আর দুধ দিছো-🙄🤦‍♂️-বইন কইলেই তো হয় বয়ফ্রেন্ড আছে-🥺🤦‍♂-আমার রিদ স্যার কে জানে মারার কি দরকার-🙄🤧",
        ...
        "-দেশের সব কিছুই চুরি হচ্ছে-🙄-শুধু আমার রিদ স্যার এর মনটা ছাড়া-🥴😑😏",
 ...
 const randomReply = (senderID === ADMIN_ID) 
   ? adminGreetings[Math.floor(Math.random() * adminGreetings.length)]
 ...
 // 👑 শুধু আপনার বার্তাগুলোর উত্তর সম্মান দিয়ে দিবে (রিদ স্যার)
